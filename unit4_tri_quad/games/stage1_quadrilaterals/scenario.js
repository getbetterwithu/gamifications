...
const STEPS = [
  ...
  // Scene 2 — 설계도 분쟁
  // ============================================================
  { type: 'scene', name: 'Scene 2 — 설계도 분쟁', bg: 'yard', clearChars: true },
  { type: 'dialog', speaker: 'narrator',
  ...
  { type: 'dialog', speaker: 'apprentice', expression: 'surprised',
    text: '저… 저요?! 첫날인데요?!' },
  { type: 'dialog', speaker: 'pythagoras', expression: 'neutral',
    text: '첫날이 아니라 첫 해라도 마찬가지다. 학당에서는 아는 만큼 보이고, 보이는 만큼 증명한다. 설계도 속 사각형들이 어떤 조건을 만족하는지 판별하여 분쟁을 해결하라. 탈레스가 돕는다.' },
  ...
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '자, 먼저 기초부터. 건축가가 "평행사변형이면 충분하다"고 했는데 — 폴리곤, 사각형이 평행사변형이 되는 조건이 몇 가지인지 알아?' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '음… 두 쌍의 대변이 평행하거나, 두 쌍의 대변의 길이가 각각 같거나…' },
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '계속해봐.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '두 쌍의 대각의 크기가 각각 같거나, 한 쌍의 대변이 평행하면서 길이도 같거나… 그리고 두 대각선이 서로 다른 것을 이등분하거나. 맞죠?' },
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '다섯 가지 완벽하게 기억하고 있네! 그럼 실전. 이 구획을 봐.' },
  ...
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '… 잠깐, 두 대각선의 길이가 같은 건 직사각형의 성질이지, 평행사변형의 조건이 아닌데요?' },
  ...
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '자, 이제 실전이야. 설계도에 사각형 구획이 네 개 그려져 있어. 이 중에서 평행사변형인 게 뭔지 골라봐. 하나일 수도 있고, 여럿일 수도 있어.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '다 비슷해 보이는데…' },
  { type: 'dialog', speaker: 'companion', expression: 'thinking',
    text: '조건을 하나씩 대입해봐요. 눈대중 말고.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '맞아. 하나씩 확인해보자.' },
  ...
  { type: 'problem', id: 'M02', kind: '메인', topic: '평행사변형 판별 (4개)', difficulty: '중',
    onCorrect: { stats: { math: 3, insight: 1 },
      dialog: { speaker: 'thales', expression: 'smile',
        text: '그렇지! 겉모양만 보면 헷갈리지. 조건을 따져야 해. 폴리곤, 눈이 정확한데?' } },
    onWrong: { stats: { math: 0 },
      dialog: { speaker: 'companion', expression: 'thinking',
        text: '괜찮아요. 조건 하나씩 대보는 게 맞는 방법이에요.' } },
  },
  ...
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '대각의 크기가 각각 같고, 이웃한 각끼리는 합이 180°가 되죠.' },
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '좋아. 그럼 직접 해봐.' },
  ...
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '수학이 설계도에만 쓰이는 줄 알아? 광장에서 본 빙글빙글 도는 놀이기구 있잖아. 그거 어떻게 수평이 유지되는지 알아?' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '무게 중심…?' },
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '평행사변형의 성질 때문이야. 대변이 평행하게 움직이니까 판이 항상 수평을 유지하는 거지.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'surprised',
    text: '아, 그래서 의자가 기울지 않는 거구나!' },
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '그렇지. 수학은 신전에도 있고 놀이에도 있어. 자, 그럼 이 원리로 문제 하나.' },
  ...
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '왜요?' },
  { type: 'dialog', speaker: 'companion', expression: 'thinking',
    text: '이 구획, 대각선 두 개가 같은 길이인데 — 수치가 정확히 나와 있어요. x랑 y를 구해야 건축가한테 정확한 치수를 줄 수 있을 것 같아요.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
    text: '직사각형이면 대각선 길이가 같고, 서로 다른 것을 이등분하니까… 그걸로 식을 세우면 되겠다.' },
  ...
  { type: 'dialog', speaker: 'companion', expression: 'thinking',
    text: '그리고 여기, 이 구획. 목장 부지 표시인데 — 정사각형이면 넓이를 구할 수 있어요.' },
  { type: 'dialog', speaker: 'apprentice', expression: 'thinking',
  ...
  { type: 'dialog', speaker: 'thales', expression: 'smile',
    text: '좋아. 그럼 마지막 확인 하나만 더. 수직 대각선이랑 직사각형 조건이 겹치면 뭐가 되는지.' },
